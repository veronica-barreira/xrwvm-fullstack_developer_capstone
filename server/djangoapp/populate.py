...
def initiate():
    car_make_data = [
        ...
        {"name": "Ferrari", "description":
            "Luxury sports cars. Italian technology"},
    ]
    ...
    car_model_data = [
        ...
        {"name": "Kluger", "type": "SUV", "year": 2023,
            "car_make": car_make_instances[4]},
        {"name": "4 Series", "type": "Coupe", "year": 2023,
            "car_make": car_make_instances[5]},
        {"name": "X1", "type": "SUV", "year": 2024,
            "car_make": car_make_instances[5]},
        {"name": "530i", "type": "Sedan", "year": 2024,
            "car_make": car_make_instances[5]},
        {"name": "SF90 Stradale", "type": "Convertible",
            "year": 2024, "car_make": car_make_instances[6]},
        {"name": "12Cilindri Spider", "type": "Coupe" "Convertible",
            "year": 2024, "car_make": car_make_instances[6]},
        {"name": "Purosangue", "type": "SUV" "Sport", "year": 2024,
